...
def main():
    ...
    p.add_argument('--reader-3b',action='store_true');a=p.parse_args()
    ...
    try:
        ...
        for case in cases['cases']:
            ...
            def predict(system,payload):
                ...
                t=time.perf_counter()
                with torch.inference_mode():generated=model.generate(**inputs,max_new_tokens=12,do_sample=False,pad_token_id=tok.eos_token_id)
